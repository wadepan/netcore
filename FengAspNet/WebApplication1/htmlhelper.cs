...
{
    public static class SCUSHtmlHelper
    {
        //public static MvcHtmlString CustomEnumDropDownListFor<TModel, TValue>(this HtmlHelper<TModel> helper, Expression<Func<TModel, TValue>> expression,
        //                                bool activeOnly, string defautlValue, Array excludeItems, object htmlAttributes)
        //{
        ...
        //                where ((Enum)enumValue).CheckInactive() != activeOnly && !excludeItems.Cast<int>().ToList().Contains((int)enumValue)
        //                select new SelectListItem
        //                {
        //                    Text = ((Enum)enumValue).GetAttribute(),
        //                    Value = ((int)enumValue).ToString(),
        //                    Selected = enumValue.Equals(metadata.Model)
        //                };

        //    return helper.DropDownListFor(expression, items, defautlValue, htmlAttributes);
        //}
